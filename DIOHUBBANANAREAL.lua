...
local T1UIColor = {
	...
	["Logo Image"] = "rbxassetid://71952783074901",
...
local Window = Library:CreateWindow({
    ...
    Image = "rbxassetid://71952783074901"
})
...
InfoTab:AddSection("DIO Hub ");
InfoTab:AddParagraph({
	Title = "DIO Hub",
	Desc = "Version: R6.1 | Game: Blox Fruits\nMade for the DIO Community\nAll features are free to use."
});
InfoTab:AddParagraph({
...
ChooseWeaponDropdown = SettingsTab:AddDropdown({
	Title = "Choose Weapon",
	Desc = "Tipo de arma para equipar durante o farm (Melee, Sword, Fruit ou Gun)",
	Values = WeaponList,
